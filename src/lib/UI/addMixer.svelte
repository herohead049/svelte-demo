...
<Modal title="Enter Mixer" bind:open={defaultModal} autoclose>
    <div id="exampleWrapper" class="grid gap-3 items-end w-full md:grid-cols-4">
      <div>
        <FloatingLabelInput
          style="outlined"
          id="floating_filled"
        ...
        />
        <Helper color="green"
          ><span class="font-medium">Enter in Name</span></Helper
        >
      </div>
      <div>
        <FloatingLabelInput
        ...
        /><Helper color="green"
          ><span class="font-medium">Enter in Type</span></Helper
        >
      </div>
      <div>
        <FloatingLabelInput
        ...
        />
        <Helper color="green"
          ><span class="font-medium">Amount</span></Helper
        >
      </div>
      ...
      <div>
        <Button
          ...
          on:click={addMixer}>Add Mixer</Button
        >
      </div>
    </div>
  </Modal>